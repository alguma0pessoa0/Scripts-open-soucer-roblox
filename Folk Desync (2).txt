...
Main.Size = UDim2.new(0, 280, 0, 145)
Main.Position = UDim2.new(0.5, -140, 0.5, -72)
Main.BackgroundColor3 = Color3.fromRGB(10, 25, 15) -- transparent dark green
...
Stroke.Color = Color3.fromRGB(20, 100, 40) -- dark green stroke
Stroke.Thickness = 2
...
Title.Text = "FOLK DESYNC"
Title.TextColor3 = Color3.fromRGB(20, 100, 40) -- dark green text
...
MinBtn.Text = "-"
MinBtn.BackgroundColor3 = Color3.fromRGB(20, 40, 25)
MinBtn.TextColor3 = Color3.fromRGB(20, 100, 40) -- dark green text
...
CloseBtn.Text = "X"
CloseBtn.BackgroundColor3 = Color3.fromRGB(20, 40, 25)
CloseBtn.TextColor3 = Color3.fromRGB(20, 100, 40) -- dark green text
...
StatusFrame.BackgroundColor3 = Color3.fromRGB(15, 35, 20) -- transparent dark green
...
StatusText.Text = "Hook active â€” packets intercepted"
StatusText.TextColor3 = Color3.fromRGB(180, 180, 180) -- Light gray
...
ToggleFrame.BackgroundColor3 = Color3.fromRGB(15, 35, 20) -- transparent dark green
...
UnwalkTitle.Text = "DESYNC"
UnwalkTitle.TextColor3 = Color3.fromRGB(20, 100, 40) -- dark green
...
UnwalkDesc.TextColor3 = Color3.fromRGB(130, 130, 140) -- Muted gray
...
ToggleButton.BackgroundColor3 = Color3.fromRGB(20, 100, 40) -- dark green
ToggleButton.Text = ""
...
ToggleButton.Activated:Connect(function()
	...
	if enabled then
		...
		print("leak by Lacsy on dc\nLeak Factions desync by Lacsy")
	else
		ToggleButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40) -- Dark gray
		Circle:TweenPosition(UDim2.new(0, 2, 0.5, -10), "Out", "Quad", 0.2, true)
		Dot.BackgroundColor3 = Color3.fromRGB(255, 50, 50)
		StatusText.Text = "Desync inactive â€” no interception"
...
MinBtn.Activated:Connect(function()
	Main:TweenSize(Content.Visible and UDim2.new(0, 280, 0, 45) or UDim2.new(0, 280, 0, 145), "Out", "Quad", 0.25, true)

-- leaked by https://discord.gg/eZ5RcpXZ7c join for more sources
...
-- ==================== PARTICLES (ZIndex 3 â€” always behind everything) ====================
...
titleLabel.Text = "Winixs Semi Tp"
...
discordLabel.Text = ".gg/USSWqKXJfA"
